...
create_passed_applicants_table = 'CREATE TABLE PassedApplicants([Id] [int] NOT NULL, [Position] [real] NULL, [ApplicationId] [nvarchar](200) NOT NULL, [Roll] [nvarchar](max) NULL,[UnitName] [nvarchar](200) NOT NULL,[TotalMarks] [real] NULL,[PhoneNumber] [nvarchar](max) NULL,[Name] [nvarchar](max) NULL,[Father] [nvarchar](max) NULL,[Photo] [nvarchar](max) NULL,[QuotaName] [nvarchar](450) NULL, [AllottedDepartment] [nvarchar](450) NULL, [AllottedDepartmentOrder] [real] NULL, [UpdatedDate] [nvarchar](450) NULL, [IsAdmissionConfirmed] [bit] null, [IsAutoMigrationOff] [bit] null, [IsAdmissionCancelled] [bit] null, [Remarks] [nvarchar](450) NULL,)'
cursor.execute(create_passed_applicants_table)

# Create Departments table
create_departments_table = 'CREATE TABLE Departments([Id] [int] NOT NULL,[Code] [nvarchar](200) NOT NULL,[DepartmentName] [nvarchar](200) NOT NULL,[UnitName] [nvarchar](10) NULL,[TotalSeats] [int], [AllottedSeats] [int], [SeatStatus] [bit], [StartingPosition] [real] NULL, [EndingPosition] [real] NULL, [UpdatedDate] [nvarchar](450) NULL)'
cursor.execute(create_departments_table)

connection_string.commit()

# Copy data from Applications table
copy_from_applications_table = "SELECT Id, UserId, ApplicationId, [Position], Roll, UnitName, TotalMarks FROM Admission2019.Applications WHERE Position IS NOT NULL ORDER BY UnitName asc, Position asc"
